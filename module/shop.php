...
<!-- Filter -->
    ...
    if (mysqli_num_rows($highestRes)) {
        while ($highestRow = mysqli_fetch_object($highestRes)) {
            $highestPrice = (int)$highestRow->price + 1000;
        }
    }
            ...
            <div class="wrapperPrice">
                <fieldset class="filter-price">
                    <div class="price-field">
                        <input type="range" name="price" min="<?php echo $lowestPrice; ?>" max="<?php echo $highestPrice-1000; ?>" value="<?php echo $lowestPrice; ?>" step="1000" id="lower">
